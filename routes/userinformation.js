...
const builduserinformationtablemiddleware = async function builduserinformationtable( req, res, next ) {
  ...
  req.userdata = user; /* storing data to be used by the request handler in the Request.locals object */
...
router.get( '/:accountid', builduserinformationtablemiddleware, (req, res, next)  => { res.render('userinformation', { 'userdata': req.userdata, 'parameterdata': req.params } ); });
