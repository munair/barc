...
const buildmargininformationtablemiddleware = async function buildmargininformationtable( req, res, next ) {
  ...
  req.margindata = margin; /* storing data to be used by the request handler in the Request.locals object */
...
router.get( '/:accountid', buildmargininformationtablemiddleware, (req, res, next)  => { res.render('margininformation', { 'margindata': req.margindata, 'parameterdata': req.params } ); });
